...
1. **CLAUDE.md** contains all writing rules, tone guidelines, SEO requirements, and accuracy standards. This file is automatically loaded when using Claude Code in this repository.
...
- All legal information must be verified for accuracy
- All content optimized for SEO, AI Overview, and schema markup
- Target location: Lafayette, Louisiana
- Disclaimer required on every piece of content
